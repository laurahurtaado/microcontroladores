/**
 * @file    i2c.c
 * @brief   Implementacion del driver I2C (MSSP) para PIC18F4550.
 * @note    Libreria original de Ing. Abiezer Hernandez O. (25/11/2019,
 *          Electronica y Circuitos). Ver i2c.h para la documentacion de la API.
 */
