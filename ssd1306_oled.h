 ...
 *
 * Trabaja sobre un buffer en RAM: se dibuja con las primitivas (texto, lineas,
 * figuras) y luego ::OLED_Update vuelca el buffer a la pantalla. Direccion I2C
 * por defecto 0x3C. Depende del driver i2c.c.
 */
#include <xc.h>
