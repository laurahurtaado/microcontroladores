/**
 * @file    ssd1306_oled.c
 * @brief   Implementacion del driver de la pantalla OLED SSD1306 por I2C.
 * @note    Incluye las tablas de fuentes (FONT_1..FONT_3) y las primitivas de
 *          dibujo. Ver ssd1306_oled.h para la documentacion de la API publica.
 */
...
void OLED_Init(void)
{
    ...
    I2C_Write(0xAD); I2C_Write(0x8B); // SH1106 charge pump

    I2C_Write(0xA1);
    I2C_Write(0xC8);

    I2C_Write(0xDA); I2C_Write(0x12);
    I2C_Write(0x81); I2C_Write(0x7F);
    I2C_Write(0xD9); I2C_Write(0x22);
    I2C_Write(0xDB); I2C_Write(0x20);
...
void OLED_Update(void)
{
    for(uint8_t page = 0; page < 8; page++)
    {
        ...
        {
            I2C_Write(buffer[page * 128 + col]); // tu buffer
        }
...
void SH1106_SetCursor(uint8_t x, uint8_t page)
{
    ...
    I2C_Write(0xB0 + page);                 // Page address
    I2C_Write(0x00 + (x & 0x0F));           // Lower column
    I2C_Write(0x10 + (x >> 4));             // Higher column
